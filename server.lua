...
RegisterNetEvent('sync-pizzeria:server:MakeTSauce', function()
    local src = source
...
RegisterNetEvent('sync-pizzeria:server:MakePizzaBase', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('sync-pizzeria:server:MakePizzaFungi', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('sync-pizzeria:server:MakeVegPizza', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local water_bottle = Player.Functions.GetItemByName('water_bottle')
    local pizzabutter = Player.Functions.GetItemByName('pizzabutter')
...
RegisterNetEvent('sync-pizzeria:server:MakeNapoPizza', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local water_bottle = Player.Functions.GetItemByName('water_bottle')
    local pizzabutter = Player.Functions.GetItemByName('pizzabutter')
...
RegisterNetEvent('sync-pizzeria:server:MakeMargharitaPizza', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local water_bottle = Player.Functions.GetItemByName('water_bottle')
...
RegisterNetEvent('sync-pizzeria:server:MakeSeafoodPizza', function()
        local src = source
        local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('sync-pizzeria:server:MakeBubbleTeaBlue', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('sync-pizzeria:server:MakeBubbleTeaMint', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('sync-pizzeria:server:Take20Dollars', function(data)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('sync-pizzeria:server:Take30Dollars', function(data)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateUseableItem("pizzabubbleteablueberry", function(source, item)
	...
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('sync-pizzeria:client:DrinkBubbleTeaBlue', source)
...
QBCore.Functions.CreateUseableItem("pizzabubbleteamint", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('sync-pizzeria:client:DrinkBubbleTeaMint', source)
...
QBCore.Functions.CreateUseableItem("pizzadrpepper", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('sync-pizzeria:client:DrinkDrPepper', source)
...
QBCore.Functions.CreateUseableItem("pizzasprite", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('sync-pizzeria:client:DrinkSprite', source)
...
QBCore.Functions.CreateUseableItem("pizzafungi", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('sync-pizzeria:client:EatPizzaFungi', source)
...
QBCore.Functions.CreateUseableItem("pizzavegpizza", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('sync-pizzeria:client:EatVegPizza', source)
...
QBCore.Functions.CreateUseableItem("pizzanapollitano", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('sync-pizzeria:client:EatNapoPizza', source)
...
QBCore.Functions.CreateUseableItem("pizzamargharita", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('sync-pizzeria:client:EatMargharitaPizza', source)
...
QBCore.Functions.CreateUseableItem("pizzaseafoodpizza", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('sync-pizzeria:client:EatSeafoodPizza', source)
        Player.Functions.RemoveItem('pizzaseafoodpizza', 1)
    end
end)

-- Bill Player
RegisterServerEvent("sync-pizzeria:server:BillPlayer")
AddEventHandler("sync-pizzeria:server:BillPlayer", function(playerId, amount)
...
RegisterNetEvent('sync-pizzeria:Server:AddItem', function(item, amount)
    local Player = QBCore.Functions.GetPlayer(source)
